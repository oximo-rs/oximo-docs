(function() {
  ...
  function initSidebar() {
    ...
    function restoreCollapsedState() {
      ...
      // Hand off from pre-paint inline class to runtime .collapsed
  ...
  function initPageTocPanel() {
    ...
    // Hand off from pre-paint inline class to runtime aria-hidden state
    document.documentElement.classList.remove('page-toc-open-init');
